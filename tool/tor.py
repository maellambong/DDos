...
if __name__ == "__main__":
    ...
    print " * Malaysia Family Attacker."
    print " * Copyright By ~MR A~"
    print " * Anony-ghost  Tor"
    print " */\n"
