...
<MMP'     `~YMMa_   YOOo   @  OOO  @   oOOP   _adMP~'      `YMM>
 ...
 _  _  ____        __       ____   __  ____       __  ____  ____  __    ___  __ _ 
( \/ )(  _ \ ___  / _\  ___(  _ \ /  \(_  _)___  / _\(_  _)(_  _)/ _\  / __)(  / )
/ \/ \ )   /(___)/    \(___)) _ ((  O ) )( (___)/    \ )(    )( /    \( (__  )  ( 
\_)(_/(__\_)     \_/\_/    (____/ \__/ (__)     \_/\_/(__)  (__)\_/\_/ \___)(__\_)
...
def help2 ():
 ...
 print ('\t |ToTurial Untuk Serangan                      |')
 print ('\t |--upload # Jumlah Bot Yang Mahu Dihantar     |')
 print ('\t |python AllienBotAttack.py www.example.com.br |')
 print ('\t |_____________________________________________|')
def zombies():
        ...
        print '\t\t {} CyberGhost Malay Hackerz'
...
if len(sys.argv) < 2:
	...
	if sys.argv[1]=="--upload":
		...
		print ("\033[95m {} Serangan Sedang Bermula ..... \033[0m\n")
